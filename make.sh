...
valac --pkg gtk+-3.0 --pkg gtksourceview-4 --pkg vte-2.91 ./src/FileOperations.vala ./src/Terminal.vala ./src/CommandParser.vala ./src/Settings.vala ./src/CodeFad.vala -o codefad
