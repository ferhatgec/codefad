...
sudo valac --pkg gtk+-3.0 --pkg gtksourceview-4 --pkg vte-2.91 ./src/FileOperations.vala ./src/EntryCompletion.vala ./src/CommandParser.vala ./src/Terminal.vala ./src/Settings.vala ./src/CodeFad.vala -o /bin/codefad
